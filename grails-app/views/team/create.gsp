                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: teamInstance, field: 'player1', 'errors')}">
                                    <g:select name="player1.id" from="${au.com.ladder.crib.Player.list()}" optionKey="id" optionValue="name"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: teamInstance, field: 'player2', 'errors')}">
                                    <g:select name="player2.id" from="${au.com.ladder.crib.Player.list()}" optionKey="id" optionValue="name"  />
                                </td>
                            </tr>
